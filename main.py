...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'warrior':
        ...
        return (f'{char_name} нанёс урон противнику равный '
                f'{base_attack_warrior}')
    if char_class == 'mage':
        base_attack_mage: int = 5 + randint(5, 10)
        return (f'{char_name} нанёс урон противнику равный '
                f'{base_attack_mage}')
    if char_class == 'healer':
        base_attack_healer: int = 5 + randint(-3, -1)
        return (f'{char_name} нанёс урон противнику равный '
                f'{base_attack_healer}')
...
def defence(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'warrior':
        ...
        return (f'{char_name} блокировал '
                f'{base_block_warrior} урона')
    if char_class == 'mage':
        base_block_mage: int = 10 + randint(-2, 2)
        return (f'{char_name} блокировал '
                f'{base_block_mage} урона')
    if char_class == 'healer':
        base_block_healer: int = 10 + randint(2, 5)
        return (f'{char_name} блокировал '
                f'{base_block_healer} урона')
